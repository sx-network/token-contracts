...
contract("RootChainManager", async (accounts) => {
  ...
  describe("Deposit ERC20", async () => {
    ...
    describe("Correct values should be emitted in LockedERC20 log", () => {
      it("Event should be emitted by correct contract", () => {
        lockedLog.address.should.equal(contracts.root.erc20Predicate.address.toLowerCase());
      });
    ...
    describe("Correct values should be emitted in StateSynced log", () => {
      ...
      it("Event should be emitted by correct contract", () => {
        stateSyncedlog.address.should.equal(contracts.root.dummyStateSender.address.toLowerCase());
      });
      ...
      it("Should emit correct contract address", () => {
        stateSyncedlog.args.contractAddress.should.equal(contracts.child.childChainManager.address);
      });
    });
    ...
    it("Deposit amount should be deducted from depositor account", async () => {
      ...
      newAccountBalance.should.be.a.bignumber.that.equals(oldAccountBalance.sub(depositAmount));
    });
    ...
    it("Deposit amount should be credited to correct contract", async () => {
      ...
      newContractBalance.should.be.a.bignumber.that.equals(oldContractBalance.add(depositAmount));
    });
  });
  ...
  describe("Deposit Ether", async () => {
    ...
    describe("Correct values should be emitted in LockedEther log", () => {
      it("Event should be emitted by correct contract", () => {
        lockedLog.address.should.equal(contracts.root.etherPredicate.address.toLowerCase());
      });
    ...
    it("Deposit amount should be deducted from depositor account", async () => {
      ...
      newAccountBalance.should.be.a.bignumber.that.equals(oldAccountBalance.sub(depositAmount).sub(gasCost));
    });
  ...
  describe("Deposit ERC721", async () => {
    ...
    describe("Correct values should be emitted in LockedERC721 log", () => {
      it("Event should be emitted by correct contract", () => {
        lockedLog.address.should.equal(contracts.root.erc721Predicate.address.toLowerCase());
      });
  ...
  describe("Deposit Single ERC1155", async () => {
    ...
    describe("Correct values should be emitted in LockedBatchERC1155 log", () => {
      it("Event should be emitted by correct contract", () => {
        lockedLog.address.should.equal(contracts.root.erc1155Predicate.address.toLowerCase());
      });
    ...
    describe("Correct values should be emitted in StateSynced log", () => {
      ...
      it("Should emit proper token id", () => {
        const [ids] = abi.decode(["uint256[]", "uint256[]", "bytes"], depositData);
        ids[0].toNumber().should.equal(depositTokenId);
      });

      it("Should emit proper amount", () => {
        const [, amounts] = abi.decode(["uint256[]", "uint256[]", "bytes"], depositData);
        const amount = new BN(amounts[0].toString());
        amount.should.be.a.bignumber.that.equals(depositAmount);
      });
  ...
  describe("Deposit Batch ERC1155", async () => {
    ...
    describe("Correct values should be emitted in StateSynced log", () => {
      ...
      before(() => {
        ...
        rootToken = data[1];
        depositData = data[2];
        const decoded = abi.decode(["uint256[]", "uint256[]", "bytes"], depositData);
        ids = decoded[0];
        amounts = decoded[1];
      });
    ...
    it("Deposit amount should be deducted from depositor account for A", async () => {
      ...
      newAccountBalance.should.be.a.bignumber.that.equals(oldAccountBalanceA.sub(depositAmountA));
    });
    ...
    it("Deposit amount should be deducted from depositor account for B", async () => {
      ...
      newAccountBalance.should.be.a.bignumber.that.equals(oldAccountBalanceB.sub(depositAmountB));
    });
    ...
    it("Deposit amount should be deducted from depositor account for C", async () => {
      ...
      newAccountBalance.should.be.a.bignumber.that.equals(oldAccountBalanceC.sub(depositAmountC));
    });
    ...
    it("Deposit amount should be credited to correct contract for A", async () => {
      ...
      newContractBalance.should.be.a.bignumber.that.equals(oldContractBalanceA.add(depositAmountA));
    });
    ...
    it("Deposit amount should be credited to correct contract for B", async () => {
      ...
      newContractBalance.should.be.a.bignumber.that.equals(oldContractBalanceB.add(depositAmountB));
    });
    ...
    it("Deposit amount should be credited to correct contract for C", async () => {
      ...
      newContractBalance.should.be.a.bignumber.that.equals(oldContractBalanceC.add(depositAmountC));
    });
  });
