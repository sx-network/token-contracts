...
export const deployFreshRootContracts = async (accounts) => {
  ...
  const mintableERC20PredicateProxy = await contracts.MintableERC20PredicateProxy.new(
    "0x0000000000000000000000000000000000000000"
  );
  await mintableERC20PredicateProxy.updateAndCall(
    mintableERC20PredicateLogic.address,
    mintableERC20PredicateLogic.contract.methods.initialize(accounts[0]).encodeABI()
  );
  ...
  const mintableERC1155PredicateProxy = await contracts.MintableERC1155PredicateProxy.new(
    "0x0000000000000000000000000000000000000000"
  );
  await mintableERC1155PredicateProxy.updateAndCall(
    mintableERC1155PredicateLogic.address,
    mintableERC1155PredicateLogic.contract.methods.initialize(accounts[0]).encodeABI()
  );
...
export const deployPotatoContracts = async (accounts) => {
  ...
  const childPotatoMigrator = await contracts.ChildPotatoMigrator.new(
    childPotatoToken.address,
    childPotatoFarm.address
  );
