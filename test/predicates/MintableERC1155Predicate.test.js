...
contract("MintableERC1155Predicate", (accounts) => {
  describe("lockTokens", () => {
    ...
    it("Should be able to receive lockTokens tx", async () => {
      lockTokensTx = await mintableERC1155Predicate.lockTokens(
        depositor,
        depositReceiver,
        dummyMintableERC1155.address,
        depositData
      );
    ...
    describe("Correct values should be emitted in LockedBatchMintableERC1155 log", () => {
      it("Event should be emitted by correct contract", () => {
        lockedLog.address.should.equal(mintableERC1155Predicate.address.toLowerCase());
      });
    ...
    it("Deposit amount should be deducted from depositor account for A", async () => {
      ...
      newAccountBalance.should.be.a.bignumber.that.equals(oldAccountBalanceA.sub(amountA));
    });
    ...
    it("Deposit amount should be deducted from depositor account for B", async () => {
      ...
      newAccountBalance.should.be.a.bignumber.that.equals(oldAccountBalanceB.sub(amountB));
    });
    ...
    it("Deposit amount should be credited to correct contract for A", async () => {
      ...
      newContractBalance.should.be.a.bignumber.that.equals(oldContractBalanceA.add(amountA));
    });
    ...
    it("Deposit amount should be credited to correct contract for B", async () => {
      ...
      newContractBalance.should.be.a.bignumber.that.equals(oldContractBalanceB.add(amountB));
    });
  });
  ...
  describe("lockTokens called by non manager", () => {
    ...
    it("Should revert with correct reason", async () => {
      await expectRevert(
        mintableERC1155Predicate.lockTokens(depositor, depositReceiver, dummyMintableERC1155.address, depositData, {
          from: depositor,
        }),
  ...
  describe("exitTokens single", () => {
    ...
    it("Withdaw amount should be deducted from contract", async () => {
      ...
      newContractBalance.should.be.a.bignumber.that.equals(oldContractBalance.sub(amount));
    });
    ...
    it("Withdraw amount should be credited to withdrawer", async () => {
      ...
      newAccountBalance.should.be.a.bignumber.that.equals(oldAccountBalance.add(amount));
    });
  });
  ...
  describe("exitTokens batch", () => {
    ...
    it("Withdaw amount should be deducted from contract for A", async () => {
      const newContractBalance = await dummyMintableERC1155.balanceOf(mintableERC1155Predicate.address, tokenIdA);
      newContractBalance.should.be.a.bignumber.that.equals(oldContractBalanceA.sub(amountA));
    });

    it("Withdaw amount should be deducted from contract for B", async () => {
      const newContractBalance = await dummyMintableERC1155.balanceOf(mintableERC1155Predicate.address, tokenIdB);
      newContractBalance.should.be.a.bignumber.that.equals(oldContractBalanceB.sub(amountB));
    });
    ...
    it("Withdraw amount should be credited to withdrawer for A", async () => {
      ...
      newAccountBalance.should.be.a.bignumber.that.equals(oldAccountBalanceA.add(amountA));
    });
    ...
    it("Withdraw amount should be credited to withdrawer for B", async () => {
      ...
      newAccountBalance.should.be.a.bignumber.that.equals(oldAccountBalanceB.add(amountB));
    });
  });
  ...
  describe("exitTokens with incorrect burn transaction signature", () => {
    ...
    it("Should revert with correct reason", async () => {
      ...
      await expectRevert(
        mintableERC1155Predicate.exitTokens(withdrawer, dummyMintableERC1155.address, burnLog),
        "MintableERC1155Predicate: INVALID_WITHDRAW_SIG"
      );
    });
  });
