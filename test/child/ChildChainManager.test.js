...
contract("ChildChainManager", async (accounts) => {
  ...
  describe("Deposit ERC20 on receiving state", async () => {
    ...
    it("Can receive ERC20 deposit sync", async () => {
      ...
      syncState = abi.encode(["bytes32", "bytes"], [syncType, syncData]);
      stateReceiveTx = await contracts.child.childChainManager.onStateReceive(syncId, syncState, { from: accounts[0] });
      should.exist(stateReceiveTx);
    });
    ...
    describe("Correct values should be emitted in Transfer log", () => {
      it("Event should be emitted by correct contract", () => {
        transferLog.address.should.equal(contracts.child.dummyERC20.address.toLowerCase());
      });
  ...
  describe("Deposit MaticWETH on receiving state", async () => {
    ...
    it("Can receive MaticWETH deposit sync", async () => {
      ...
      stateReceiveTx = await contracts.child.childChainManager.onStateReceive(syncId, syncBytes, { from: accounts[0] });
      should.exist(stateReceiveTx);
    });
    ...
    describe("Correct values should be emitted in Transfer log", () => {
      it("Event should be emitted by correct contract", () => {
        transferLog.address.should.equal(contracts.child.maticWETH.address.toLowerCase());
      });
  ...
  describe("Deposit ERC721 on receiving state", async () => {
    ...
    it("Token should not exist before deposit", async () => {
      await expectRevert(
        contracts.child.dummyERC721.ownerOf(depositTokenId),
    ...
    describe("Correct values should be emitted in Transfer log", () => {
      it("Event should be emitted by correct contract", () => {
        transferLog.address.should.equal(contracts.child.dummyERC721.address.toLowerCase());
      });
  ...
  describe("Deposit ERC1155 on receiving state", async () => {
    ...
    describe("Correct values should be emitted in TransferBatch log", () => {
      it("Event should be emitted by correct contract", () => {
        transferLog.address.should.equal(contracts.child.dummyERC1155.address.toLowerCase());
      });
